...
struct FSMData {
  ...
  std::shared_ptr<LocalTrajectory> newest_traj_;  // Store latest planned trajectory
};
...
struct ExplorationData {
  ExplorationData()
  {
    ...
    object_confidences_.clear();
    object_observation_nums_.clear();
  ...
  std::vector<double> object_confidences_;
  std::vector<int> object_observation_nums_;
